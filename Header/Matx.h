...
namespace Mathf
{
	...
	inline Matx3F Translation(const Vector2& translationVector)
	{
	...
	inline Matx3F Scale(const Vector2& scaleVector)
	{
		return D2D1::Matrix3x2F::Scale(D2D1::SizeF(scaleVector.x, scaleVector.y));
	}

	inline Matx3F Scale(const Vector2& scaleVector, Point2F point)
	{
